...
Public Class FichaCodigoBarra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "codigobarras.FichaCodigoBarra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFichaCodigoBarra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FichaCodigoBarra = New FichaCodigoBarra()
        rpt.Site = Me.Site
        Return rpt
    End Function
